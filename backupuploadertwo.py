    ...
    def on_internet_available(self, agent):
        ...
        if last_session.is_new() and last_session.handshakes > 0:
            ...
            try:
                ...
                with open(picture, backup_file,'rb') as image:
                    requests.post(self.options['webhook_url'], files={'file': ('pwnagotchi-backup.tar.gz', backup_file), 'image': image, 'payload_json': (None, json.dumps(data))})
